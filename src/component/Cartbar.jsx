  ...
  return (
    <>
      ...
      <div
        ...
        transition-all flex flex-col duration-300 ease-in-out ${openCart === true ? `right-0` : `-right-full`}`}
      >
                ...
                <div key={i} className="flex justify-between">
                  <div className="flex items-center gap-x-3">
                    ...
                    <div className="flex flex-col">
                      ...
                      <h5 className=" font-medium text-dark-gray">IDR {numberWithCommas(item.price)}</h5>
                    </div>
                  </div>
        ...
        <div className=" flex justify-between mb-12">
          ...
          <h4 className="text-black font-medium text-lg">IDR {numberWithCommas(230000)}</h4>
        </div>
